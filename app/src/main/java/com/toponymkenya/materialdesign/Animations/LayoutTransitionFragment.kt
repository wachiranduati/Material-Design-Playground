 ...
 * Use the [LayoutTransitionFragment.newInstance] factory method to
...
class LayoutTransitionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment LayoutTransitionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            LayoutTransitionFragment().apply {
